...
namespace CAMDM
{
    ...
    public class InBetweenNetwork
    {
        ...
        public TensorFloat Inference(TensorFloat pastMotion, TensorFloat startMotion, TensorFloat endMotion, TensorFloat styleFearture, TensorFloat tta, float guidanceScale)
        {
            ...
            for (int i = diffusionParams.diffusion_steps-1; i >= 0; i--)
            {
                ...
                inputTensor["start_motion"] = startMotion;
                inputTensor["end_motion"] = endMotion;
            ...
            startMotion.MakeReadable();
            endMotion.MakeReadable();
